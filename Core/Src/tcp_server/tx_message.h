...
void tx_message_set_adc_dr_uV(tx_message_t *self, int32_t val); // 4
void tx_message_set_hv_out_mV(tx_message_t *self, int32_t val); // 4
void tx_message_set_press_out_Pa(tx_message_t *self, int32_t val); // 4
void tx_message_set_adc_dr_average_uV(tx_message_t *self, int32_t val); // 4
