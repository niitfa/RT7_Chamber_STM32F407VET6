...
C_SRCS += \
../Core/Src/pressure_sensor/pressure_sensor.c 

OBJS += \
./Core/Src/pressure_sensor/pressure_sensor.o 

C_DEPS += \
./Core/Src/pressure_sensor/pressure_sensor.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/pressure_sensor/%.o Core/Src/pressure_sensor/%.su Core/Src/pressure_sensor/%.cyclo: ../Core/Src/pressure_sensor/%.c Core/Src/pressure_sensor/subdir.mk
...
clean: clean-Core-2f-Src-2f-pressure_sensor

clean-Core-2f-Src-2f-pressure_sensor:
	-$(RM) ./Core/Src/pressure_sensor/pressure_sensor.cyclo ./Core/Src/pressure_sensor/pressure_sensor.d ./Core/Src/pressure_sensor/pressure_sensor.o ./Core/Src/pressure_sensor/pressure_sensor.su

.PHONY: clean-Core-2f-Src-2f-pressure_sensor
