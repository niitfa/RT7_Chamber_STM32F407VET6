...
Core/Src/tcp_server/%.o Core/Src/tcp_server/%.su: ../Core/Src/tcp_server/%.c Core/Src/tcp_server/subdir.mk
...
clean-Core-2f-Src-2f-tcp_server:
	-$(RM) ./Core/Src/tcp_server/rx_message.d ./Core/Src/tcp_server/rx_message.o ./Core/Src/tcp_server/rx_message.su ./Core/Src/tcp_server/tcp_input_stream.d ./Core/Src/tcp_server/tcp_input_stream.o ./Core/Src/tcp_server/tcp_input_stream.su ./Core/Src/tcp_server/tcp_output_stream.d ./Core/Src/tcp_server/tcp_output_stream.o ./Core/Src/tcp_server/tcp_output_stream.su ./Core/Src/tcp_server/tx_message.d ./Core/Src/tcp_server/tx_message.o ./Core/Src/tcp_server/tx_message.su
